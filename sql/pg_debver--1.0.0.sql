...
\echo Use "CREATE EXTENSION pg_debver" to load this file. \quit
...
CREATE CAST (text AS debversion)     WITH FUNCTION debversion(text) AS ASSIGNMENT;
...
CREATE AGGREGATE min(debversion)  (
    ...
    STYPE = debversion,
    COMBINEFUNC = debversion_smaller,
    SORTOP = <,
    PARALLEL = SAFE
);
